...
function AnimatedRotationScene({ question, targetRotation, isSuccessVisible }: RotationSceneProps) {
...
function StaticRotationScene({ question, targetRotation, isSuccessVisible }: RotationSceneProps) {
  return (
    <group>
      <ambientLight intensity={1.7} />
      <directionalLight position={[4, 6, 5]} intensity={2.2} castShadow />
